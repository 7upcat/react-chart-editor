...
const StyleTracesPanel = (props, {localize: _}) => (
  <TraceAccordion canGroup>
    ...
    <PlotlySection name={_('Binning')}>
      <Numeric label={_('X Bin Start')} attr="xbins.start" />
      <Numeric label={_('X Bin End')} attr="xbins.end" />
      <Numeric label={_('X Bin Size')} attr="xbins.size" />
      <Numeric label={_('Max X Bins')} attr="nbinsx" />
      <Numeric label={_('Y Bin Start')} attr="ybins.start" />
      <Numeric label={_('Y Bin End')} attr="ybins.end" />
      <Numeric label={_('Y Bin Size')} attr="ybins.size" />
